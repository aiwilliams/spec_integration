      ...
      class IntegrationExample < ActionController::IntegrationTest
        ...
        class << self
          ...
          def suite
            ...
            suite = Spec::DSL::ExampleSuite.new(description, self)
        ...
        private
          ...
          def execute_in_class_hierarchy(superclass_first)
            classes = []
            current_class = self
            while current_class.is_a?(Spec::DSL::Behaviour)
          ...
          def add_examples_from_methods(suite)
            instance_methods.each do |method_name|
              if (is_test?(method_name) || is_spec?(method_name)) && (
                ...
                example_definition = Spec::DSL::ExampleDefinition.new(method_name) do
        ...
        Spec::DSL::BehaviourFactory.register(:integration, self)
      end
